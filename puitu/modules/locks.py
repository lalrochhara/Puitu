...
import puitu.modules.sql.locks_sql as sql
from puitu import dispatcher, SUDO_USERS, LOGGER
from puitu.modules.disable import DisableAbleCommandHandler
from puitu.modules.helper_funcs.chat_status import (
    can_delete,
    is_user_admin,
    is_bot_admin,
...
from puitu.modules.helper_funcs.chat_action import send_message, typing_action
