...
import os
import re
import puitu.modules.sql.lang_sql as lang
...
from puitu import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, DEFAULT_LANG, VERSION

from puitu.strings.string_helper import  get_string

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from puitu.modules import ALL_MODULES
from puitu.modules.helper_funcs.chat_status import is_user_admin
from puitu.modules.helper_funcs.misc import paginate_modules
from puitu.modules.helper_funcs.misc import is_module_loaded
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("puitu.modules." + module_name)
...
def about(update: Update, context: CallbackContext):
    DEVELOPMENT = " - [Nicky Lalrochhara](https://github.com/NickyLrca)\n" \
    ...
    TRANSLATION = " - [Nicky Lalrochhara](https://t.me/NickyLrca) - Quality Control\n" \
    ...
    PRODUCTION = " - [Nicky Lalrochhara](https://github.com/NickyLrca) - Owner\n" \
                                        " - [Mizo Tlangval](https://t.me/unlessj) - Co-Owner\n" \
...
def load_api():
        if is_module_loaded("rest"):
            import puitu.restapi as restapi
