...
Can be found on telegram as [Mr.Puitu](https://t.me/MrPuitu).
## Installing the bot
...
This file should be placed in your `puitu` folder, alongside the `__main__.py` file . 
...
```
from puitu.sample_config import Config
